<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baja.aspx.cs" Inherits="ASPInyeccionSQL.baja" %>
...
<body>
    <form id="form1" runat="server">
        <div id="container">
            ...
            <div class="controles">
                <asp:Button ID="btnBuscar" CssClass="btnFinal" runat="server" Text="Borrar" OnClick="btnBuscar_Click"/>
